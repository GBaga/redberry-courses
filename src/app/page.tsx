...
export default function Home() {
  ...
  return (
    <div className="container mx-auto px-4 sm:px-6 lg:px-8 py-6 md:py-8 max-w-[1440px]">
      ...
      <div className="relative rounded-[24px] overflow-hidden mb-12 shadow-sm aspect-auto xl:aspect-[4/1] min-h-[320px] lg:min-h-[360px] xl:min-h-[300px] transition-all duration-700 ease-in-out">
         ...
         <div className="relative h-full flex flex-col justify-center px-5 lg:px-10 xl:px-16 w-full max-w-4xl z-10 animate-in fade-in slide-in-from-bottom-4 duration-500" key={currentSlide}>
           <h1 className="text-2xl lg:text-4xl xl:text-5xl font-extrabold text-white mb-4 tracking-tight drop-shadow-md">
             {slides[currentSlide].title}
           </h1>
           <p className="text-white/90 text-sm lg:text-base font-medium mb-8 max-w-2xl drop-shadow">
             {slides[currentSlide].text}
           </p>
           <div>
             {slides[currentSlide].href ? (
               <Button asChild size="md" className="bg-indigo-600 hover:bg-indigo-700 text-white border-0 px-6 py-3 lg:px-7 lg:py-4 xl:px-8 xl:py-6 h-auto rounded-lg text-sm lg:text-base shadow-lg shadow-indigo-900/20">
                 <Link href={slides[currentSlide].href}>{slides[currentSlide].btnText}</Link>
               </Button>
             ) : (
               <Button onClick={slides[currentSlide].onClick} size="md" className="bg-indigo-600 hover:bg-indigo-700 text-white border-0 px-6 py-3 lg:px-7 lg:py-4 xl:px-8 xl:py-6 h-auto rounded-lg text-sm lg:text-base shadow-lg shadow-indigo-900/20">
         ...
         <div className="absolute bottom-4 lg:bottom-6 xl:bottom-8 right-4 lg:right-10 xl:right-16 flex items-center gap-4 lg:gap-6 xl:gap-8 z-20">
